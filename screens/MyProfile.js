...
import { Tasklist1, Taskboder, Content, Input, CustomText, ContentWrapper,TextValue,TextHead } from '../css/MyProfile.css';
    ...
    if (selected === 'tab1') {
        return (
            <View style={{ flex: 1 }}>
                ...
                <Tasklist1 style={{ flex: 9 }}>
                    ...
                    <View>
                        <Text style={{ alignSelf: 'center',fontFamily:'RobotoSlab-Regular', fontSize: 25 }}>{profileData?.t_First_Name} {profileData?.t_Last_Name}</Text>
                        <Text style={{ alignSelf: 'center', fontSize: 14, fontFamily:'RobotoSlab-Regular' }}>Assistant Manager</Text>
                    </View>

                    <Taskboder>
                        <Content style={{ flexDirection: 'row' }}>
                            <TextHead >Emp Code</TextHead>
                            <TextValue style={{ fontSize: 14 }}>{profileData?.a_EmployeeId}</TextValue>
                        </Content>

                        <Content >
                            <TextHead >Email Id</TextHead>
                            <TextValue >{profileData?.t_Email}</TextValue>
                        </Content>

                        <Content>
                            <TextHead >Username</TextHead>
                            <TextValue>{profileData?.t_UserName}</TextValue>
                        </Content>

                        <Content>
                            <TextHead >Department</TextHead>
                            <TextValue>{DepartmentName}</TextValue>
                        </Content>
        ...
        return (
            <View style={{ paddingBottom: 40 }}>
                <ScrollView>
                    <View>
                        <Text style={{ fontSize: 20, marginTop: 20, alignSelf: 'center', fontFamily:'RobotoSlab-Bold' }}>Basic Details</Text>
                    </View>
...
class MyProfile extends Component {
    ...
    _onRefresh = async () => {
        ...
        // await this.setState({ departmentData: this.props.departmentData });
        ...
        await this.setState({ refreshing: false, roleList: roleList, country: countryData, state: stateData, city: cityData });
    ...
    static getDerivedStateFromProps(props, state) {
        ...
        if (props.departmentData !== state.departmentData) {
            return {
    ...
    //     // Comparing previous props to current props
