...
import {
  ...
  getTaskPriority,
  getTaskStatus,
} from '../redux/Action/CreateTask.action';
...
class CreateTask extends Component {
  ...
  handleImage = async () => {
    const source = ImagePicker.showImagePicker(options, async response => {
            ...
            <ScrollView>
              <View style={{paddingLeft: 10, marginTop: 20, paddingRight: 10}}>
                ...
                <View
                  ...
                  {this.state.n_DepartmentIdError ? (
                    <Text style={{marginTop: 15, color: 'red'}}>
                      {this.state.n_DepartmentIdError}
                    </Text>
                  ) : null}
                  ...
                  <Picker
                    ...
                    {departmentList?.map((e, i) => {
                      return (
                        <Picker.Item
                          key={i}
                          label={e?.t_DepartmentName}
                          value={e?.a_DepartmentId}
                        />
                      );
                    })}
                  </Picker>
                ...
                <View
                  ...
                  {this.state.n_AssigneeEmployeeIdError ? (
                    <Text style={{marginTop: 15, color: 'red'}}>
                      {this.state.n_AssigneeEmployeeIdError}
                    </Text>
                  ) : null}
                ...
                <InputGroup>
                  <Picker
                    ...
                    onValueChange={(itemValue, itemIndex) =>
                      itemValue && this.setState({assignee: itemValue})
                    }>
                    <Picker.Item label="Select" value={null} />
                    {assineeList?.map((e, i) => {
                      return (
                        <Picker.Item
                          key={i}
                          label={e.t_First_Name}
                          value={e.a_EmployeeId}
                        />
                      );
                    })}
                  </Picker>
                ...
                <InputGroup>
                  ...
                  {show && mode === 'date' ? <DateTimePicker
                      ...
                      display={'calendar'}
                      onChange={(event, date) =>
                        this.onChange(event, date, selectedInput)
                      }
                ...
                <InputGroup>
                  <TextInput
                    ...
                    value={toDate}
                    onFocus={() => {
                      this.setState({...dateObj, selectedInput: 'toDate'});
                    }}
                  />
                ...
                <View
                  ...
                  {this.state.d_ReportSubmissionDateError ? (
                    <Text style={{marginTop: 15, color: 'red'}}>
                      {this.state.d_ReportSubmissionDateError}
                    </Text>
                  ) : null}
                ...
                <View
                  ...
                  {this.state.d_ReportSubmissionTimeError ? (
                    <Text style={{marginTop: 15, color: 'red'}}>
                      {this.state.d_ReportSubmissionTimeError}
                    </Text>
                  ) : null}
                ...
                <InputGroup>
                  <TextInput
                    style={{width: '87%'}}
                    value={taskAssignTime}
                    onFocus={() => {
                      this.setState({
                        ...timeObj,
                        selectedInput: 'taskAssignTime',
                      });
                    }}
                  />
                  <Icon
                ...
                <View
                  ...
                  {this.state.n_TaskPriorityIdError ? (
                    <Text style={{marginTop: 15, color: 'red'}}>
                      {this.state.n_TaskPriorityIdError}
                    </Text>
                  ) : null}
                ...
                <InputGroup>
                  <Picker
                    ...
                    onValueChange={(itemValue, itemIndex) =>
                      itemValue && this.setState({taskPriority: itemValue})
                    }
                ...
                <View
                  ...
                  {this.state.n_TaskStatusIDError ? (
                    <Text style={{marginTop: 15, color: 'red'}}>
                      {this.state.n_TaskStatusIDError}
                    </Text>
                  ) : null}
                ...
                <View
                  ...
                  {this.state.t_AttachmentFileError ? (
                    <Text style={{marginTop: 15, color: 'red'}}>
                      {this.state.t_AttachmentFileError}
                    </Text>
                  ) : null}
                ...
                <TouchableOpacity
                  onPress={() => this.submitHandler('SUBMIT')}
